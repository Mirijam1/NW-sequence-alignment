...
int main(int argc, char *argv[]){
    ...
    app.add_option("--predictalignnw", PREDICT_ALIGN_NW, "When predicting and there is no outgoing transition, the model remaining trace is aligned to the model using the Needleman-Wunsch algorithm. Default=0.");
    app.add_option("--nwscoring", NW_SCORING, "Different scoring mechanism for predict align with Needleman-Wunsch, options: 'static', 'linear' or 'dynamic'. Default=static.");
